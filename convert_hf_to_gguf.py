...
class LazyTorchTensor(gguf.LazyBase):
    ...
    _dtype_byteswap_map: dict[torch.dtype, type] = {
        ...
        getattr(torch, 'uint64', torch.int64): np.uint64,
        torch.int32: np.int32,
        getattr(torch, 'uint32', torch.int32): np.uint32,
        torch.int16: np.int16,
        getattr(torch, 'uint16', torch.int16): np.uint16,
        torch.int8: np.int8,
        getattr(torch, 'uint8', torch.int8): np.uint8,
        torch.bool: np.uint8,
