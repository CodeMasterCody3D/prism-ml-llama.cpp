    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                (type == GGML_TYPE_Q1_0 || type == GGML_TYPE_Q1_0_g128 || type == GGML_TYPE_Q1_SD_g128 || type == GGML_TYPE_Q1_SD_g32 || type == GGML_TYPE_Q1_T_g128) ? MAX_QUANTIZATION_TOTAL_ERROR_BINARY :
            ...
            const float max_allowed_error = type == GGML_TYPE_Q2_K || type == GGML_TYPE_IQ2_XS || type == GGML_TYPE_IQ2_XXS ||
                                          ...
                                          : (type == GGML_TYPE_Q1_0 || type == GGML_TYPE_Q1_0_g128 || type == GGML_TYPE_Q1_SD_g128 || type == GGML_TYPE_Q1_SD_g32 || type == GGML_TYPE_Q1_T_g128)
