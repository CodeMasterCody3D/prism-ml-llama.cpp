...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q1_T_g128] = {
        .type_name                = "q1_t_g128",
        .blck_size                = QK1_T_g128,
        .type_size                = sizeof(block_q1_t_g128),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_t_g128,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_t_g128_ref,
    },
    [GGML_TYPE_Q1_0_g32] = {
        .type_name                = "q1_0_g32",
        .blck_size                = QK1_0_g32,
        .type_size                = sizeof(block_q1_0_g32),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_0_g32,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_0_g32_ref,
    },
    [GGML_TYPE_Q1_0_g64] = {
        .type_name                = "q1_0_g64",
        .blck_size                = QK1_0_g64,
        .type_size                = sizeof(block_q1_0_g64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_0_g64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_0_g64_ref,
    },
    [GGML_TYPE_Q1_SD_g128] = {
        .type_name                = "q1_sd_g128",
        .blck_size                = QK1_SD_g128,
        .type_size                = sizeof(block_q1_sd_g128),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_sd_g128,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_sd_g128_ref,
    },
    [GGML_TYPE_Q1_SD_g32] = {
        .type_name                = "q1_sd_g32",
        .blck_size                = QK1_SD_g32,
        .type_size                = sizeof(block_q1_sd_g32),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_sd_g32,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_sd_g32_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q1_0_g64:      wtype = GGML_TYPE_Q1_0_g64;   break;
        case GGML_FTYPE_MOSTLY_Q1_SD_g128:    wtype = GGML_TYPE_Q1_SD_g128; break;
        case GGML_FTYPE_MOSTLY_Q1_SD_g32:     wtype = GGML_TYPE_Q1_SD_g32;  break;
        case GGML_FTYPE_MOSTLY_Q1_T_g128:     wtype = GGML_TYPE_Q1_T_g128;  break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q1_0_g64:  result = quantize_q1_0_g64(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_0_g128: result = quantize_q1_0_g128(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_SD_g128: result = quantize_q1_sd_g128(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_SD_g32:  result = quantize_q1_sd_g32(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_Q1_T_g128:  result = quantize_q1_t_g128(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
