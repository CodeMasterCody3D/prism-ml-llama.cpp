...
GGML_API void quantize_row_q1_r_g128_ref(const float * GGML_RESTRICT x, block_q1_t_g128 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_q1_r_g128(const block_q1_t_g128 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
