...
to_fp16_cuda_t ggml_get_to_fp16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q1_0_g32:
            return dequantize_block_cont_cuda<QK1_0_g32, QR1_0_g32, dequantize_q1_0_g32>;
        case GGML_TYPE_Q1_0_g64:
            return dequantize_block_cont_cuda<QK1_0_g64, QR1_0_g64, dequantize_q1_0_g64>;
        case GGML_TYPE_Q4_0:
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q1_0_g32:
            return dequantize_block_cuda<QK1_0_g32, QR1_0_g32, dequantize_q1_0_g32>;
        case GGML_TYPE_Q1_0_g64:
            return dequantize_block_cuda<QK1_0_g64, QR1_0_g64, dequantize_q1_0_g64>;
        case GGML_TYPE_Q4_0:
