...
template<>
struct ggml_cuda_type_traits<GGML_TYPE_Q1_T_g128> {
    static constexpr int qk = QK1_T_g128;
    static constexpr int qr = QR1_T_g128;
    static constexpr int qi = QI1_T_g128;
};
